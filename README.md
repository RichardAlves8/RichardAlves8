...
### Linguagens
![Go](https://img.shields.io/badge/-Go-00ADD8?style=flat-square&logo=go&logoColor=white) ![SQL](https://img.shields.io/badge/-SQL-003B57?style=flat-square&logo=sqlite&logoColor=white) ![VBA](https://img.shields.io/badge/-VBA-217346?style=flat-square&logo=microsoft-excel&logoColor=white) ![Java](https://img.shields.io/badge/-Java-007396?style=flat-square&logo=java&logoColor=white) ![M](https://img.shields.io/badge/-%20M-1E3A5F?style=flat-square)
...
- Programação e Soluções Computacionais <i>(160h)</i>
 >- Java
...
- **SPDF-GO** — CLI em Go para geração de PDFs de ordem de produção a partir de planilhas `.xlsm`.
- **ChangePass XLS** — ferramenta em Go para rotação de credenciais OLE DB em arquivos Excel, tratando XLSX como ZIP.
